		...
		<div class="header_top-sec">
			...
			<div class="top_left">
				<ul>
					...
					<li class="top_link">
                    	<a href="login.php"><b>My Account</b></a>
                    </li>|					
				</ul>
				<div class="social">
					<ul>
...
<div class="header_right">
			...
			<div class="cart box_1">
				<a href="cart.php">
					<h3>
                    	 <!--<span class="simpleCart_total">$0.00</span> --><span>Rs.0.00</span> 
                         (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span>items)
...
<div class="new">
	 <div class="container">
<!--<h3>specially designed for Hydraulic Cylinder</h3>-->		 
			 ...
			 <div class="item1">
					 ...
					 <?php
					 	...
					 	if(isset($_GET['Product_id']))
						{
							...
							$get_pro= "select * from product_mst where Product_id='$product_id'";
							...
							while($row_pro=mysqli_fetch_array($run_pro))
							{
								...
								echo "
										<div>
											...
											<img src='Admin/product_images/$Product_image' width='400' height='300' /><br><br>
											<p><b>Part No: $Product_partno</b></p>
											<p><b>Size: $Product_size</b></p>
											<p><b>Rs: $Product_price</b></p><br>
