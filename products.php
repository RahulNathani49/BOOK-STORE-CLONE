...
<html>
<head>
<title>Online Book Store | Home :: w3layouts</title>
...
<div class="header_top">
	 <div class="container">
		 <div class="logo">
		 	<a href="index.php"><img src="images/imgs/2.jpg"alt=""/></a>			 
		 </div>
		<div>
		 ...
		 <div class="header_right">	
			 ...
			 <div class="cart box_1">
				<a href="cart.php">
					<h3> <!--<span class="simpleCart_total">$0.00</span> --><span>Rs.0.00</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span> items)<img src="images/bag.png" alt=""></h3>
				</a>	
		 ...
		 <div class="col-md-9 product-model-sec">
					 <a href="single.php"><div class="product-grid love-grid">
						...
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/imgs/Dozer Hydraulic Cylinder/dozerblade17-new.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust prt_name">
								...
								<p>ID: SR4598</p>
								<span class="item_price">Rs.187.95</span>								
			...
			<div class="rsidebar span_1_of_left">
				 <section  class="sky-form">
					 <div class="product_right">
						 ...
						 <div class="tab1">
							 <ul class="place">								
								 <li class="sort">Excavator Hydraulic Cylinder</li>
						  ...
						  <div class="tab2">
							 <ul class="place">								
								 <li class="sort">Loader Hydraulic Cylinder</li>
								 <li class="by"><img src="images/do.png" alt=""></li>
									<div class="clearfix"> </div>
							  </ul>
							 <div class="single-bottom">						
						  ...
						  <div class="tab3">
							 <ul class="place">								
								 <li class="sort">Dumper Hydraulic Cylinder</li>
								 <li class="by"><img src="images/do.png" alt=""></li>
									<div class="clearfix"> </div>
							  </ul>
							 <div class="single-bottom">						
						  ...
						  <div class="tab4">
							 <ul class="place">								
								 <li class="sort">Dozer Hydraulic Cylinder</li>
								 <li class="by"><img src="images/do.png" alt=""></li>
									<div class="clearfix"> </div>
							  </ul>
							 <div class="single-bottom">						
	 ...
	 <div class="container">
		 <div class="ftr-grids">
			 ...
			 <div class="col-md-3 ftr-grid">
				 <h4>Categories</h4>
				 <ul>
					 <li><a href="#">> Excavator Hydraulic Cylinder</a></li>
					 <li><a href="#">> Loader Hydraulic Cylinder</a></li>
					 <li><a href="#">> Dumper Hydraulic Cylinder</a></li>
					 <li><a href="#">> Dozer Hydraulic Cylinder</a></li>		 
				 </ul>
			 </div>
			 <div class="clearfix"></div>
		 </div>
