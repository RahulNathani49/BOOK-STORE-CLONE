...
<html>
<head>
<title>Online Book Store | Facilities :: w3layouts</title>
	 ...
	 <div class="container">
		...
		<ul class="megamenu skyblue">
			...
			<?php /*?> <li class="grid"><a class="color2" href="#">Product</a><?php */?>
				...
				<li class="active grid"><a class="color5" href="facilities.php">facilities</a></li>
		 ...
		 <div class="contact-head">
	 					...
	 					<div class="container">
		 					<div class="slider">
								<ul class="rslides" id="slider1">
                                  <li><img src="images/imgs/facilities-banner.jpg" alt=""></li>
                                </ul>
		 					</div>
	 					</div>
					</div>
             ...
             <span class="style1">
          		<div align="" style="float:left;">
                	<a href="#"><img src="images/imgs/vtl-sk8.jpg"></a>
                    <div style="padding-left:150px; font-size:10px;">
                    	<b>VTL - SK 8</b>
                    </div>
                      <div  style="padding-left:50px; font-size:12px;">
                        <p>
                        	<b>Machine Name :</b>	VTL<br>
                            <b>Mfg. Company :</b>	TOS<br>
                            <b>Machine Model :</b>	SK 8<br>
                            <b>Machine Type :</b>	Heavy Duty Single Ram, <br>
                                            Side Tool Post Vertical<br>
                                            Lathe (VTL)<br>
                            <b>Chuck Diameter :</b>	Ø 750 mm<br>
                            <b>Swing Diameter :</b>	Ø1070 mm<br>
                            <b>Job Height :</b>	600 mm<br>
                            <b>Job Weight :</b>	2.5 TONNE<br>
                        </p>
                    </div>
                </div>
                <div align="" style="float:left; margin-left:130px;">
                	<a href="#"><img src="images/imgs/vtl-sk12.jpg"></a>
                    <div style="padding-left:150px; font-size:10px;">
                    	<b>VTL - SK 12</b>
                    </div>
                      <div  style="padding-left:50px; font-size:12px;">
                        <p>
                        	<b>Machine Name :</b>	VTL<br>
                            <b>Mfg. Company :</b>	TOS<br>
                            <b>Machine Model :</b>	SK 12<br>
                            <b>Machine Type :</b>	Heavy Duty Single Ram &  <br>
                                           Turret, Side Tool Post<br>
                                            Vertical Lathe (VTL)<br>
                            <b>Chuck Diameter :</b>	Ø 1180 mm<br>
                            <b>Swing Diameter :</b>	Ø1450 mm<br>
                            <b>Job Height :</b>	1000 mm<br>
                            <b>Job Weight :</b>	5 TONNE<br>
                        </p>
                    </div>
                </div>
                <div align="" style="float:right;">
                	<a href="#"><img src="images/imgs/vtl-sse22.jpg"></a>
                    <div style="padding-left:150px; font-size:10px;">
                    	<b>VTL - SSE 22</b>
                    </div>
                      <div  style="padding-left:50px; font-size:12px;">
                        <p>
                        	<b>Machine Name :</b>	VTL<br>
                            <b>Mfg. Company :</b>	SSE, ITALY<br>
                            <b>Machine Model :</b>	SSE 22<br>
                            <b>Machine Type :</b>	Heavy Duty Single Ram & <br>
                                            Turret, Side Tool Post <br>
                                            Vertical Lathe (VTL)<br>
                            <b>Chuck Diameter :</b>	Ø 750 mm<br>
                            <b>Swing Diameter :</b>	Ø2250 mm<br>
                            <b>Job Height :</b>	1275 mm<br>
                            <b>Job Weight :</b>	3 TONNE<br>
                        </p>
                    </div>
                </div> 
             </span>
