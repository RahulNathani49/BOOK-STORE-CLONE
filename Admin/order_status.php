                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
						...
						<ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="order_status.php">Manage Order Status</a>
                            </li>
                  		</ul>
                    </li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Manage Order<small>&nbsp;&nbsp;Manage Order Status</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
			...
			<div class="panel panel-default">
							...
							<div class="panel-body"> 
								<table width="985px" align="center" bgcolor="pink">
                                   	<tr align="center">
    									<td colspan="8" bgcolor="#3498db"><h2>View All Order By Complete Status</h2><br /></td>
    								</tr>
