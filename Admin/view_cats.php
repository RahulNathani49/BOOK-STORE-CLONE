                  ...
                  <li>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="view_cats.php">View All Category</a>
                            </li>
                        </ul>
                    </li>
			...
			<div class="panel panel-default">
							...
							<div class="panel-body"> 
								<table width="985px" align="center" bgcolor="pink">
                                    <tr align="center">
                                        <td colspan="6" bgcolor="#3498db"><h2>View All Categories Here</h2><br /></td>
                                    </tr>
                                    ...
                                    <?php
										...
										$get_cat = "select * from category_mst";
                                   ...
                                   <tr>
                                        ...
                                        <td><a href="edit_cat.php?edit_cat=<?php echo $Category_id;?>">Edit</a></td>
