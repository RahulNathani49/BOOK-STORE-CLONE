		...
		<div class="header_top-sec">
			<div class="top_right">
				<ul>
					...
					<li><a href="login.php"><b>Track Order</b></a></li>
				</ul>
			</div>
			<div class="top_left">
				<ul>
					...
					<li class="top_link">
                    	<a href="my_account.php"><b>My Account</b></a>
                    </li>|					
				</ul>
				<div class="social">
					<ul>
...
<div class="mega_nav">
	 <div class="container">
		 ...
		 <ul class="megamenu skyblue">
			 ...
			 <li class="active grid"><a class="color2" href="all_products.php">All Product</a>
				<!--<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
...
<!--<h3>specially designed for Hydraulic Cylinder</h3>-->		 
		<div class="new-products">
		 <div class="new-items">
             ...
             $get_pro="select * from product_mst where Product_name like '%$search_query%'";
			 ...
			 $count_search = mysqli_num_rows($run_pro);
					...
					if($count_search==0)
					{
						echo "<h2 style='padding:20px;'>No Products where found in this Search Value!</h2>";
					}
