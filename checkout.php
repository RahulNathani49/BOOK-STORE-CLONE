     ...
     <?php /*?><?php
		 			...
		 			if(!isset($_SESSION['Cus_email']))
					{
						...
						echo "<div class='login'>
						 <a href='checkout.php'><b>LOGIN</b></a>
			 				<span class='style1'></span>
              				</div>";
					}
					else
					{
						echo "<div class='login'><a href='logout.php'><b>Logout<b></a><span class='style1'></span>";
					}
		 ...
		 ?><?php */?>
			...
			<div class="cart box_1" >
				...
				<?php /*?><p><a href="javascript:empty()">Empty cart</a></p><?php */?>
				<div class="clearfix"> </div>
			 </div>	
