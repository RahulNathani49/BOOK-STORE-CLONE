...
function getPro()
{
	...
	while($row_pro=mysqli_fetch_array($run_pro))
	{
		...
		echo "
				<div class='col-md-3 seller-grid py-5 ' >
					<h3>$Product_name</h3>
					...
					<a href='details.php?Product_id=$Product_id' style=' color:#026466;padding:10px 0 15px;'>Details</a>
                    <br>
					<a href='index.php?add_cart=$Product_id'><button type='button' class='btn btn-outline-success '>Add to Cart</button></a>
